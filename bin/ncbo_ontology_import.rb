...
SOURCE_API =  ARGV[0] || 'http://data.bioontology.org'
SOURCE_APIKEY = ARGV[1] ||  '8b5b7825-538d-40e0-9e9e-5ab9274a9aeb'
...
ONTOLOGIES_TO_IMPORT = ARGV[2].split(',') || []
